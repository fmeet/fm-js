...
export enum EventType {
     ...
     */
    RoomAliases = "m.room.aliases", // deprecated https://facemeeting.com/docs/spec/client_server/r0.6.1#historical-events
    ...
    // use of this is discouraged https://facemeeting.com/docs/spec/client_server/r0.6.1#m-room-message-feedback
