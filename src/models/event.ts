...
export class MatrixEvent extends EventEmitter {
     ...
     * from changes to event JSON between FM versions.
     *
    ...
    constructor(public event: Partial<IEvent> = {}) {
        ...
        // field that FaceMeeting never otherwise looks at, but it will still take up a lot
     ...
     * @return {string} The user ID, e.g. <code>@alice:facemeeting.com</code>
     */
     ...
     * @return {string} The room ID, e.g. <code>!cURbafjkfsMDVwdRDQ:facemeeting.com
     * </code>
     */
 ...
 *  http://facemeeting.com/speculator/spec/HEAD/client_server/latest.html#redactions
 *
 * Also:
