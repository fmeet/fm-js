...
export class Room extends EventEmitter {
    ...
    constructor(
        ...
        super();
        // In some cases, we add listeners for every displayed FM event, so it's
    ...
    private checkVersionAgainstCapability(versionCap: IRoomVersionsCapability): IRecommendedVersion {
        ...
        // off the version being in the FM spec namespace or not (if the version
     ...
     * @param {string} userId the ID of the FM user to check permissions for
