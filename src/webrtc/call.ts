 ...
 * @param {MatrixClient} opts.client The FM Client instance to send events to.
 */
    ...
    private async sendAnswer(): Promise<void> {
        const answerContent = {
            answer: {
                ...
                // type is now deprecated as of FM VoIP v1, but
 ...
 *
 * Create a new FM call for the browser.
