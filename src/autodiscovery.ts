...
// See: https://facemeeting.com/docs/spec/client_server/r0.4.0.html#server-discovery
...
export class AutoDiscovery {
    ...
    public static readonly ERROR_INVALID_HOMESERVER = "Homeserver URL does not appear to be a valid FM homeserver";
     ...
     * on. For example, "facemeeting.com".
