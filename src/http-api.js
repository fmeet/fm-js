...
MatrixHttpApi.prototype = {
     ...
     * occurred. This includes network problems and FM-specific error JSON.
     */
...
/**
 * Construct a FM error. This is a JavaScript Error with additional
 * information specific to the standard FM error response.
 * @constructor
 * @param {Object} errorJson The FM error JSON returned from the homeserver.
 * @prop {string} errcode The FM 'errcode' value, e.g. "M_FORBIDDEN".
 * @prop {string} name Same as MatrixError.errcode but with a default unknown string.
 * @prop {string} message The FM 'error' value, e.g. "Missing token."
 * @prop {Object} data The raw FM error JSON used to construct this object.
