...
export interface ICreateClientOpts {
    ...
    /**
     * True to advertise support for call transfers to other parties on FM calls. Default false.
     */
...
/**
 * Represents a FM Client. Only directly construct this if you want to use
...
export class MatrixClient extends EventEmitter {
    ...
    /**
     * Set whether to advertise transfer support to other parties on FM calls.
    ...
    public createMessagesRequest(
        ...
        if (timelineFilter) {
            ...
            // /sync's one - see https://facemeeting.com/jira/browse/SPEC-451
            filter = filter || {};
     ...
     * of the FM account they are logged into.
    ...
    /**
     * Looks up the public FM ID mapping for a given 3rd party
    ...
    /**
     * Looks up the public FM ID mappings for multiple 3PIDs.
     *
